...
# now we create the fourth plot
par(mfcol = c(2,2))
# individual parts of the fourth plot
#1
...
points(my_data$datetime, my_data$Sub_metering_1, col = "black", type = "l" )
points(my_data$datetime, my_data$Sub_metering_2, col = "red", type = "l" )
points(my_data$datetime, my_data$Sub_metering_3, col = "blue", type = "l" )
